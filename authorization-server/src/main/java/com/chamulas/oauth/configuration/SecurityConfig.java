package com.chamulas.oauth.configuration;
...
import com.chamulas.oauth.services.CustomsUserDetails;
...
public class SecurityConfig {
	...
	@Bean
	PasswordEncoder passwoeEncoder()
	{
	...
	@Bean 
	UserDetailsService userDetailsService(CustomsUserDetails customsUserDetails) {
		return customsUserDetails;
	}
	...
	@Bean
	CommandLineRunner initData(UsuarioRepository userRepo, RolRepositry rolRepo, PasswordEncoder encoder) {
	    return args -> {
