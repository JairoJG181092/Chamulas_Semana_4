	...
	import com.chamulas.oauth.dto.ErrorResponse;
	...
	public class GlobalExceptionHandler {
	    ...
	    public ResponseEntity<ErrorResponse> handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
	        log.error("Faltan parámetros requeridos en la petición: {}", e.getMessage());
	        return ResponseEntity.badRequest().body(
	    ...
	    public ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(DataIntegrityViolationException e) {
	        log.error("Error en la integridad de los datos: {}", e.getMostSpecificCause().getMessage());
	        return ResponseEntity.badRequest().body(
	                new ErrorResponse(HttpStatus.BAD_REQUEST.value(), e.getMostSpecificCause().getMessage())
	        );
	    }*/
	    ...
	    public ResponseEntity<ErrorResponse> handleException(Exception e) {
	        log.error("Error del servidor: ", e);
